...
yq e ".serviceProviders[0].type=\"${SPI_TYPE:-GitHub}\"" $ROOT/components/spi/base/config.yaml | \
    ...
    yq e ".serviceProviders[1].type=\"${SPI_TYPE:-Quay}\"" $ROOT/components/spi/base/config.yaml | \
...
USER_WORKSPACE=${USER_APPSTUDIO_WORKSPACE-"user-workspace"} ${ROOT}/hack/create-user-workspace.sh "user-workspace"
